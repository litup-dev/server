...
import {
    ...
    PerformanceForMarketingListResponseType,
...
export class PerformanceService {
    ...
    async getPerformancesByDateRangeForMarketing(
        query: GetPerformanceByDateRangeType
    ): Promise<PerformanceForMarketingListResponseType> {
        const { startDate, endDate, isFree, area } = query;
        ...
        return {
            items: performances.map((p) => ({
                ...
                club: {
                    ...
                    name: p.club_tb.name,
                    address: p.club_tb.address,
                    instagramAccount: `@${p.club_tb.instagram_account}`,
                },
                images: p.perform_img_tb.map((img) => ({
                    id: img.id,
                    filePath: img.file_path,
